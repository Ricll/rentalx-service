...
var updateAvatarUserController = new UpdateUserAvatarController_1.UpdateUserAvatarController();
var profileUserController = new ProfileUserController_1.ProfileUserController();
usersRoutes.post("/", createUserController.handle);
usersRoutes.patch("/avatar", ensureAuthenticated_1.ensureAuthenticated, uploadAvatar.single("avatar"), updateAvatarUserController.handle);
