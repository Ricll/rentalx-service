...
var AuthenticateUserUseCase = /** @class */ (function () {
    function AuthenticateUserUseCase(usersRepository, usersTokenRepository, dayJsDateProvider) {
    ...
    AuthenticateUserUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user, secret_token, expires_in_token, secret_refresh_token, expires_in_refresh_token, expires_refresh_token_days, passwordMatch, token, refresh_token, refresh_token_expires_date, tokenReturn;
