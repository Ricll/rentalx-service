...
var CreateUserUserCase_1 = require("../createUser/CreateUserUserCase");
...
describe("Authenticate User", function () {
    beforeEach(function () {
        ...
        createUserUseCase = new CreateUserUserCase_1.CreateUserUseCase(usersRepositoryInMemory);
    });
    ...
    it("should not be able to authenticate nonexistent user", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
