...
var RefreshTokenUseCase = /** @class */ (function () {
    function RefreshTokenUseCase(userTokensRepository, dayJsDateProvider) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        user_id = sub;
                        return [4 /*yield*/, this.userTokensRepository.findByUserIdAndRefreshToken(user_id, token)];
                    case 1:
                        userToken = _b.sent();
                        if (!userToken) {
                            throw new AppError_1.AppError("Refresh Token does not exists!");
                        }
                        return [4 /*yield*/, this.userTokensRepository.deleteById(userToken.id)];
                    case 2:
                        _b.sent();
                        ...
                        return [4 /*yield*/, this.userTokensRepository.create({
