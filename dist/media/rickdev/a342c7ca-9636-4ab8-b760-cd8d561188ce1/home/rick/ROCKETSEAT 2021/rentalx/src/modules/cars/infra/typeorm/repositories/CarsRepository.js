...
var CarsRepository = /** @class */ (function () {
    ...
    CarsRepository.prototype.create = function (_a) {
        var brand = _a.brand, daily_rate = _a.daily_rate, description = _a.description, category_id = _a.category_id, fine_amount = _a.fine_amount, license_plate = _a.license_plate, name = _a.name, specifications = _a.specifications, id = _a.id;
    ...
    CarsRepository.prototype.findAvailable = function (brand, name, category_id) {
        return __awaiter(this, void 0, void 0, function () {
            var carsQuery, cars;
            return __generator(this, function (_a) {
                switch (_a.label) {
